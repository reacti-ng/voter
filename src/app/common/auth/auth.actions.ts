...
export class SetAuthToken {
  ...
  constructor(readonly app: keyof any, readonly token?: OAuth2Token, readonly useTimestamp?: Date) {}
}
...
export class SetLoginRedirect {
  ...
  constructor(readonly app: keyof any, readonly redirectTo: string) {}
}
...
export class BeginAuthorizationCodeGrant {
  ...
  constructor(readonly app: keyof any, readonly request: AuthorizationCodeGrantRequest) {}
}
...
export class FinalizeAuthorizationCodeGrant {
  ...
  constructor(readonly app: keyof any, readonly redirectUri: string, readonly response: AuthorizationCodeGrantResponse) {}
}

export const REFRESH_TOKEN = 'common.auth: begin refresh token';
export class RefreshToken {
  readonly type = REFRESH_TOKEN;
  constructor(readonly app: keyof any) {}
}
...
export class SetTokenPersistenceIsEnabled {
  ...
  constructor(readonly app: keyof any, readonly isEnabled: boolean) {}
}
